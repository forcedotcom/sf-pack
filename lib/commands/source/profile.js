...
export default class Profile extends CommandBase {
    static defaultSourceFolder = null;
    static defaultPermissionsGlobs = [
        '**/profiles/*.profile-meta.xml',
        '**/permissionsets/*.permissionset-meta.xml',
    ];
    static description = CommandBase.messages.getMessage('source.profile.commandDescription');
    static examples = [
    ...
    async runInternal() {
        ...
        // Debug
        const customObjects = new Set(Utils.sortArray(custObjs));
