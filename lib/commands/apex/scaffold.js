...
const scaffold_options_1 = require("../../helpers/scaffold-options");
...
class Scaffold extends command_base_1.CommandBase {
    ...
    async runInternal() {
        ...
        if (flags.options) {
            ...
            options = await options_factory_1.OptionsFactory.get(scaffold_options_1.ScaffoldOptions, optionsFilePath);
            if (!options) {
        ...
        const project = await sf_project_1.default.default();
    ...
    async getSchema(sObjectType) {
        ...
        if (!schema) {
            schema = await sf_tasks_1.SfTasks.describeObject(this.org, sObjectType);
            if (!schema) {
...
Scaffold.flags = {
    sobjects: sf_plugins_core_1.Flags.string({
        char: 's',
