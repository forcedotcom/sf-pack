...
$ NODE_OPTIONS=--inspect-brk bin/run.cmd api file get -r ./test/files/api/ContentVersionGet.csv -f test/files/api/cvFiles
$ NODE_OPTIONS=--inspect-brk bin/run.cmd api file get -u ORG_ALIAS -r test/ContentVersionIds.csv -f ./Files
$ NODE_OPTIONS=--inspect-brk bin/run.cmd api file post -r test/files/api/ContentVersion.csv -f test/files/api/ContentVersion
...
EXAMPLES
  $ sf api file get -u myOrgAlias -r ContentVersions.csv  -o ./output/files
